...
import { ContextMenuContext } from "../context/SongMenuContext";
...
export function ContextMenuProvider({ children }) {
    ...
    return (
        <ContextMenuContext.Provider value={{ menuSong, setMenuSong, menuPosition, setMenuPosition, playlistSubmenu, setPlaylistSubmenu, menuRef, submenuSide }}>
            {children}
