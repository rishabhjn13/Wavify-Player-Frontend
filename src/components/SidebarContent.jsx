        ...
        <>
            ...
            <nav style={{ padding: "0 12px", flexShrink: 0 }}>
                {[
                    ...
                    { id: "artists", label: "Artists", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><circle cx="12" cy="8" r="4" /><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" /></svg> },
                ].map(n => (
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "0 10px 12px" }}>
                ...
                {playlists.map(pl => (
                        <div key={pl.id}
                            ...
                            onClick={() => {console.log("Opening playlist:", pl); setActivePL(pl); setView("playlist"); if (setSidebarOpen) setSidebarOpen(false); openPlaylist(pl); }}>
                            <div style={{
                                width: 36,
                                height: 36,
                                borderRadius: 7,
            ...
            <div style={{ padding: "12px 14px", borderTop: "1px solid #13112a", display: "flex", alignItems: "center", gap: 10, flexShrink: 0, cursor: "pointer" }} onClick={() => { setView("profile"); if (setSidebarOpen) setSidebarOpen(false); }}>
                <div style={{ width: 34, height: 34, borderRadius: "50%", background: "linear-gradient(135deg,#7c3aed,#a855f7)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, flexShrink: 0 }}>U</div>
                <div style={{ minWidth: 0 }}>
                    <div style={{ fontSize: 13, fontWeight: 600, color: "#ddd6f3" }}>User</div>
                    <div style={{ fontSize: 11, color: "#5a507a" }}>Free Plan</div>
                </div>
