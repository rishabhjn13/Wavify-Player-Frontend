export default function PlaylistMenu({ playlist, position, onClose, onDelete, onPlay, notify }) {
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{ padding: "10px 14px 10px", borderBottom: "1px solid #131126", marginBottom: 4 }}>
                    <div style={{ fontSize: 13, fontWeight: 600, color: "#f0ecff" }}>{playlist.name}</div>
                    <div style={{ fontSize: 11, color: "#5a507a", marginTop: 1 }}>{playlist.count} songs</div>
                </div>

                <div className="ctx-item" onClick={() => { onPlay(playlist); onClose(); }}>
                ...
                <div className="ctx-item" onClick={() => { notify("Coming soon"); onClose(); }}>
                ...
                <div className="ctx-item" onClick={() => { onDelete(playlist.id); onClose(); }}
                    style={{ color: "#f87171" }}
